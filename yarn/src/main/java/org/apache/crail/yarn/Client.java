...
import org.apache.crail.yarn.CommonUtils;
//import alluxio.util.io.PathUtils;
//import alluxio.yarn.YarnUtils.YarnContainerType;

import org.apache.crail.yarn.Constants;
import org.apache.crail.yarn.FormatUtils;
import org.apache.crail.yarn.PathUtils;
import org.apache.crail.yarn.YarnUtils.YarnContainerType;
import org.apache.crail.yarn.PathUtils;
...
public final class Client {
    ...
    static CrailConfiguration conf;
    ...
    public static void main(String[] args) {
        try {
            ...
            //NEWLY ADDED FOR ON THE FLY YARN CONF SETTING
    ...
    private boolean parseArgs(String[] args) throws ParseException {
        ...
        mAppName = cliParser.getOptionValue("appname", "CRAIL");
    ...
    private void checkClusterResource(GetNewApplicationResponse appResponse) {
        ...
        //int masterMemInMB = 2000000000 / Constants.MB;

        int masterMemInMB = 10000;


        //NEWLY ADDED FOR DYNAMIC CONF SETTING IN YARN BY KAUSTAV 13/07/2019
        //int masterMemInMB = Integer.parseInt(conf.get("crail.cachelimit"));
        ...
        //int workerMemInMB = Integer.parseInt(conf.get("crail.cachelimit"));
        //int ramdiskMemInMB = Integer.parseInt(conf.get("crail.cachelimit"));

        int workerMemInMB = 10000;
        int ramdiskMemInMB = 10000;
        //int workerMemInMB = 1000000000 / Constants.MB;
        //int ramdiskMemInMB = 1000000000 / Constants.MB;
    ...
    private void setupContainerLaunchContext() throws IOException, YarnException {
        ...
        localResources.put("crail.tar.gz",
                YarnUtils.createLocalResourceOfFile(mYarnConf, mResourcePath + "/crail.tar.gz"));
        localResources.put("crail-yarn-setup.sh",
                YarnUtils.createLocalResourceOfFile(mYarnConf, mResourcePath + "/crail-yarn-setup.sh"));
        localResources.put("crail-yarn.jar",
                YarnUtils.createLocalResourceOfFile(mYarnConf, mResourcePath + "/crail-yarn.jar"));
    ...
    private void setupAppMasterEnv(Map<String, String> appMasterEnv) throws IOException {
        ...
        appMasterEnv.put("CRAIL_HOME", ApplicationConstants.Environment.PWD.$());
