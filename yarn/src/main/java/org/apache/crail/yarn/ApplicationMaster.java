...
public final class ApplicationMaster implements AMRMClientAsync.CallbackHandler {
    ...
    public ApplicationMaster(int numWorkers, String masterAddress, String resourcePath,
        ...
        System.out.print(mMasterMemInMB);

        mWorkerCpu = 2;
        // TODO(binfan): request worker container and ramdisk container separately
        // memory for running worker
        //mWorkerMemInMB = (int) (Configuration.getBytes(PropertyKey.INTEGRATION_WORKER_RESOURCE_MEM) / Constants.MB);

        //mWorkerMemInMB = 1000000000 / Constants.MB;
        mWorkerMemInMB = 7000;

        System.out.print("/n");

        System.out.print(mWorkerMemInMB);

        System.out.print("/n");

        // memory for running ramdisk
        //mRamdiskMemInMB = (int) (Configuration.getBytes(PropertyKey.WORKER_MEMORY_SIZE) / Constants.MB);
        //mRamdiskMemInMB = 1000000000 / Constants.MB;
        mRamdiskMemInMB = 7000;

        System.out.print(mRamdiskMemInMB);
        ...
        System.out.print(mMasterAddress);
        ...
        System.out.print(mResourcePath);
    ...
    public static void main(String[] args) {
        ...
        options.addOption("num_workers", true, "Number of CRAIL workers to launch. Default 1");
        options.addOption("master_address", true, "(Required) Address to run CRAIL master");
    ...
    private static void runApplicationMaster(final CommandLine cliParser) throws Exception {
        ...
        System.out.print(masterAddress);
        System.out.print(resourcePath);

        System.out.print("CHKPT1");
    ...
    public void start() throws IOException, YarnException {
        ...
        System.out.print("CHKPT22");

        mRMClient.init(mYarnConf);
        mRMClient.start();

        System.out.print("CHKPT33");

        mYarnClient.init(mYarnConf);
        mYarnClient.start();

        System.out.print("CHKPT44");
